...
#define EEPROM_CS_HIGH()    HAL_GPIO_WritePin(SPI4_NSS_EEPROM_GPIO_Port, SPI4_NSS_EEPROM_Pin, GPIO_PIN_SET)
#define EEPROM_CS_LOW()     HAL_GPIO_WritePin(SPI4_NSS_EEPROM_GPIO_Port, SPI4_NSS_EEPROM_Pin, GPIO_PIN_RESET)
...
int32_t EEPROM_SPI_Read_int32_t(uint16_t WriteAddr);
